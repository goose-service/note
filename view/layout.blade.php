        ...
        <div class="header-search dropdown-content">
          <form action="{{__ROOT__}}/" method="get" id="search_keyword">
            <fieldset>
              ...
              <span>
                <input type="text" name="q" placeholder="Please search keyword" value="{{$_GET['q'] ?? ''}}">
...
<script type="module">
import RedgooseApp from '{{__ROOT__}}/assets/dist/app.es.js';
window.app = new RedgooseApp();
</script>
@yield('script')
</body>
</html>
